    ...
    <div class="grid grid-cols-12 w-screen bg-gray-50">
      ...
      <div class="col-span-10 md:col-span-8 lg:col-span-6 py-8 pr-0 md:pr-12"
        ...
        <p class="inter text-gray-800 text-md leading-6 pb-4">
          The ESports Platform is a web application for gamers and companies that want to host events and tournaments. The platform allows users to create events and tournaments, and allows companies to host events and tournaments for a variety of games.
        </p>
